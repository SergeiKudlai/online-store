...
export const DATA: IDATA[] = [
  { id: 4, name: 'Клубника быстрозамороженная, 1 кг, фасовка 0,8 -1,0 кг', img: strawberry, price: 30, availability: true, brand: 'Бабушкина грядка' },
  { id: 4, name: 'Лимон, 1кг', img: lemon, price: 100, availability: true, brand: 'Мадагаскар' },
  { id: 1, name: 'Кофе с коноплей органический Caffe Salomoni 250г', img: coffee, price: 200, availability: true, brand: 'Caffe Salomoni' },
  { id: 5, name: 'Набор шоколадных конфет ассорти «Дед Мороз у камина» 255 г', img: candy, price: 70, availability: true, brand: 'Дед Мороз у камина' },
  ...
  { id: 3, name: 'Перец красный, 1 кг, фасовка 0,6 -0,8 кг', img: pepper_red, price: 70, availability: true, brand: 'Бабушкина грядка' },
  { id: 1, name: 'Напиток газированный Coca-Cola 1 л', img: cola, price: 70, availability: true, brand: 'pepsi-cola' },
  { id: 2, name: 'Мандарин, 1 кг, фасовка 1 - 1,2 кг', img: orange, price: 135, availability: true, brand: 'Мадагаскар' },
  { id: 1, name: 'Вода питьевая «Bonaqua» среднегазированная 1 л', img: bonaqua2, price: 50, availability: true, brand: 'Bonaqua' },
  { id: 4, name: 'Черешня, 1 кг, фасовка 0,2 - 0,25 кг', img: сherry, price: 35, availability: true, brand: 'Свой огород' },
  { id: 5, name: 'Верхушка на елку «Волшебная страна» 15х15 см', img: star, price: 400, availability: true, brand: 'Волшебная страна' },
  { id: 3, name: 'Капуста белокачанная, 1 кг, фасовка 2,2 - 3,0 кг', img: cabbage, price: 70, availability: true, brand: 'Свой огород'},
  { id: 1, name: 'Вода питьевая «Bonaqua» сильногазированная 1 л', img: bonaqua, price: 50, availability: true, brand: 'Bonaqua' },
  { id: 3, name: 'Морковь молодая с бабушкиной грядки, 1кг', img: carrot, price: 300, availability: false, brand: 'Свой огород' },
  { id: 2, name: 'Питахайя красная с белой мякотью, 1шт', img: dragonFruit, price: 400, availability: true, brand: 'Жаркая страна' },
  { id: 2, name: 'Гранат, 1 кг, фасовка 0,7 - 0,9 кг', img: granat, price: 155, availability: true, brand: 'Жаркая страна' },
  { id: 1, name: 'Напиток сокосодержащий Sanpellegrino Aranciata Orange', img: juice, price: 500, availability: false, brand: 'Sanpellegrino Aranciata' },
  { id: 4, name: 'Клюква лесная, 180 г', img: сranberry, price: 35, availability: true, brand: 'Бабушкина грядка' },
  { id: 5, name: 'Зубная паста «R.O.C.S.» максимальная свежесть, 94 г г', img: paste, price: 150, availability: true, brand: 'R.O.C.S.' },
